		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<input id="ckfinder-input-1" type="hidden" name="hinhanh" style="width:60%">
						<img id="hinhanh" src="./resources/img/images/avatar.jpg" alt="" class="img-fluid" style="width:300px; height:200px;">
						<!-- <button id="ckfinder-popup-1" class="button-a button-a-background">Browse Server</button> -->
						<input onclick="selectFileWithCKFinder('ckfinder-input-1')" type="button" name="btnChonFile" id="btnChonFile" value="Chọn file" />
							...
							<?php foreach ($data2 as $value2 ) {
								foreach($data3 as $value3){
									if($value3['idDM']==$value2['idDM']){
												...
												?>
							<option value="<?php echo $value2['idTL'] ?>" selected><?php echo $value3['TenDM']." - ".$value2['TenTL'] ?></option>
							<?php }}}?>
						</select>
					</div>
					<textarea name="NoiDung" class="ckeditor" id="ckeditor" required></textarea>
					<div class="form-group">
