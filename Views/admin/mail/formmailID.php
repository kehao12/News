                    ...
                    <div class="controls">
                        ...
                        <div class="col-md-12">
                                <div class="form-group">
                                    <label for="form_lastname">Email nhận</label>
                                    <?php foreach($data as $value){?>
                                    <input id="form_lastname" type="text" name="to" class="form-control"
                                        placeholder="<?php echo $value['Email']  ?>" disabled required="required"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="form_lastname">Chủ đề</label>
                                    <input id="form_lastname" type="text" name="subject" class="form-control"
                                        placeholder="Điền chủ đề *" required="required"
                                        data-error="Lastname is required.">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="ckeditor" id="ckeditor" name="message" class="form-control"
                                        placeholder="Điền nội dung *" rows="4" required="required"
                                        data-error="Sai nhập liệu"></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
