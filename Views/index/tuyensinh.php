                ...
                <div class="blog-all-wrap mr-40">
                            ...
                            <div class="single-blog mb-30">
                                ...
                                <div class="blog-content-wrap">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <div class="blog-meta">
                                            <ul>
                                                <li><a href="#"><i class="fa fa-user"></i><?= $value['TaiKhoan']?></a></li>
                    ...
                    <div class="pro-pagination-style text-center mt-25">
                        <ul>
                           ...
                           <li><a class="prev" href="?controller=index&action=tuyensinh&page=<?php echo ($current_page-1) ?>"><i class="fa fa-angle-double-left"></i></a></li>
                           <?php } ?>
                           <?php for($i=1; $i<=$total_page;$i++){
                           if ($i == $current_page){
                           ?>
                           <li><a class="active" href="?controller=index&action=tuyensinh&page=<?php echo $i?>"><?php echo $i?></a></li>
                           <?php } else {?>
                           <li><a href="?controller=index&action=tuyensinh&page=<?php echo $i?>"><?php echo $i?></a></li>
                           <?php }}?>
                           <?php if ($total_page > 1){?>
                           <li><a class="next" href="?controller=index&action=tuyensinh&page=<?php echo ($current_page-1) ?>"><i class="fa fa-angle-double-right"></i></a></li>
                           <?php }?>
                       </ul>
                   </div>
               </div>
