                ...
                <div class="blog-all-wrap mr-40">
                    ...
                    <div class="pro-pagination-style text-center mt-25">
                        <ul>
                           ...
                           <li><a class="prev" href="?controller=index&action=monhoc&page=<?php echo ($current_page-1) ?>"><i class="fa fa-angle-double-left"></i></a></li>
                           <?php } ?>
                           <?php for($i=1; $i<=$total_page;$i++){
                           if ($i == $current_page){
                           ?>
                           <li><a class="active" href="?controller=index&action=monhoc&page=<?php echo $i?>"><?php echo $i?></a></li>
                           <?php } else {?>
                           <li><a href="?controller=index&action=monhoc&page=<?php echo $i?>"><?php echo $i?></a></li>
                           <?php }}?>
                           <?php if ($total_page > 1){?>
                           <li><a class="next" href="?controller=index&action=monhoc&page=<?php echo ($current_page-1) ?>"><i class="fa fa-angle-double-right"></i></a></li>
                           <?php }?>
                       </ul>
                   </div>
               </div>
                ...
                <div class="sidebar-category mb-40">
                    ...
                    <div class="category-list">
                        <ul>
                            ...
                            if($value['idDM']==8){?>
                            <li><a href="?controller=index&action=bvtl&id=<?= $value['idTL']?>"><?= $value['TenTL']?> <?php foreach($dem as $value1){
